...
import { Button, MainContainer, ChipViewContainer, Clickable, FloatingEditText, ScrollContainer,
     ViewWithTitle, MyFlatList, ProgressView, ImageButton } from '../../common'
import { Button as DialogButton, TextInput, Dialog, Portal, RadioButton, Menu } from 'react-native-paper'

const TaskAttachmentUi = ({ onBrowse, documentName, onEdit, attachments, selectedAttachment, onDone, loading, onDismissed, visibleDialog, editMode, onDocumentNameChanged, onDelete, onEditDone, visibleEditDialog }) => {
...
export default TaskAttachmentUi
