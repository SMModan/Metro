...
export default class NotifService {
    constructor(onRegister, onNotification) {
        ...
        this.bgHandler = messaging().setBackgroundMessageHandler(async remoteMessage => {
            // Alert.alert('A new FCM message arrived!', JSON.stringify(remoteMessage));
            onNotification(remoteMessage)
        })
    ...
    createOrUpdateChannel() {
        ...
        PushNotification.createChannel(
            {
                channelId: "Skyward", // (required)
                channelName: `Skyward Notifications`, // (required)
                channelDescription: `Skyward Notifications`, // (optional) default: undefined.
    ...
    localNotif(message, title) {
        this.lastId++;
        console.log("localNotification---", message)
    ...
    scheduleNotif() {
        console.log("notification is scheduleded",Date.now())
        this.lastId++;
